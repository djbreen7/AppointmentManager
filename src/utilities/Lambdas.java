...
public class Lambdas {
     ...
     * @param name The name of the country to match.
     * @return The Country with the provided name.
     */
    public static Country getCountryByName(List<Country> list, String name) {
     ...
     * @param name The name of the division to match.
     * @return The FirstLevelDivision with the provided name.
     */
    public static FirstLevelDivision getDivisionByName(List<FirstLevelDivision> list, String name) {
     ...
     * @return A List of FirstLevelDivision with the country id.
     */
     ...
     * @return The Contact with the provided name.
     */
     ...
     * @return The first Customer with the provided name.
     */
     ...
     * @return Appointments for the given week.
     */
     ...
     * @return Appointments for the given month.
     */
